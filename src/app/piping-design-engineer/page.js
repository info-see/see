  ...
  return (
    <>
      <div className="w-full mt-20">
        ...
        <div className="detailing mt-20 px-6 lg:px-4">
          <div className="container flex flex-col gap-16">
            <div className="about-job">
              ...
              <h5 className="custom-h5 font-sans-font-medium lg:leading-custom-36 leading-custom-28 pt-6">
                We are looking for a highly skilled and experienced Piping
                Design Engineer to join our team. The ideal candidate should
                possess a graduate degree in Mechanical Engineering and have 3
                to 10 years of experience in piping layout conceptualization. A
                thorough understanding of common equipment and the routing of
            ...
            <div className="about-you">
              ...
              <h5 className="custom-h5 font-sans-font-medium lg:leading-custom-36 leading-custom-28 pt-2">
